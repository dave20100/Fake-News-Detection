...
nigdy nie brała udziału w tego typu filmach a całe nagranie zostało stworzone wykorzystując technologię sztucznej
...
mogąc oskarżyć dowolną osobę o zbrodnie, z którą nie miała ona żadnego związku. 
...
z nagrania aktora Jordana Peele, które następnie zostało podrobione technologią ``deep fake''.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{./Img/peele.jpg}
    \caption{Klatka z filmu firmy Buzzfeed}
\end{figure}
