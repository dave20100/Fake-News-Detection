...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Wyniki tych algorytmów wyglądają bardzo podobnie, dla długości równej 1 mają
        one efektywność około 80\%. Podnoszenie rozmiaru NGramów powoduje znaczne zwiększenie
        możliwości predykcyjnych algorytmów i każdy z nich już 
        \item \textbf{Naive Bayes} -
        Algorytm Naive Bayes zwiększa sw
    \end{itemize}
