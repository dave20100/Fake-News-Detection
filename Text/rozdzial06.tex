...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Algorytmy KNN oraz Naive Bayes osiągneły najlepsze wyniki czasu trwania fazy uczenia i podczas 
        trwania całego badania nie trwała ona dłużej niż sekundę.
        Jest to spowodowane względnie prostymi operacjami wykonywanymi przez nie podczas tej fazy. 
        Zadaniem algorytmu KNN jest jedynie zapisanie wszystkich danych, Naive Bayes natomiast 
        oblicza prawdopodobieństwa na podstawie prostych kalkulacji wykonywanych podczas jednej iteracji. 
        \item \textbf{Random forest} -
        Czas trwania fazy uczenia dla algorytmu Random Forest ulega niewielkiemu wydłuzaniu podczas zmiany rozmiaru 
        ...
        ulega znacznemu zwiększeniu przy większej liczbie cech ponieważ algorytm wybiera tylko najważniejsze cechy do tworzenia 
        drzewa.
        \item \textbf{SVC, MLP} -
